...
raw_train_file = os.path.join(args.data_dir, "train.keywords.txt")
raw_valid_file = os.path.join(args.data_dir, "valid.keywords.txt")
raw_test_file = os.path.join(args.data_dir, "test.keywords.txt")
