...
data_arg.add_argument("--min_len", type=int, default=1)
data_arg.add_argument("--max_len", type=int, default=1)
...
optim_arg.add_argument("--adam_betas", type=any, default=(0.9,0.999))
optim_arg.add_argument("--weight_decay", type=float, default=0.0001)

# Inference
infer_arg = parser.add_argument_group("Inference")
infer_arg.add_argument("--beam_size", type=int, default=10)
infer_arg.add_argument("--min_infer_len", type=int, default=1)
infer_arg.add_argument("--max_infer_len", type=int, default=1)
...
def main():
    ...
    args.Data.train_file = args.Data.train_file or os.path.join(
        args.Data.data_dir, "train.keywords.txt.pkl")
    args.Data.valid_file = args.Data.valid_file or os.path.join(
        args.Data.data_dir, "valid.keywords.txt.pkl")
    args.Data.test_file = args.Data.test_file or os.path.join(
        args.Data.data_dir, "test.keywords.txt.pkl")
    ...
    '''
    Optimizer_torch = getattr(torch.optim, args.Optim.optimizer)
    params = list(
        filter(
    ...
    optimizer_torch = Optimizer_torch(params, lr=args.Optim.lr, betas=args.Optim.adam_betas,
    ...
    if args.infer:
        ...
        infer_data = dataset.load_examples(args.train_file)
